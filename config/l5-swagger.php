...
return [
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            /**
             * analyser: defaults to ReflectionAnalyser with AttributeAnnotationFactory only.
             * Add DocBlockAnnotationFactory to support PHPDoc @OA\ annotations.
             *
             * @see \OpenApi\scan
             */
        ...
        */
        'securityDefinitions' => [
            ...
            'security' => [
                /*
                 * Global: all API endpoints require Bearer token (login overrides with security: [])
                 */
                [
                    'bearerAuth' => [],
                ],
